...
def test_views_omit_hidden_cards_history_rng_and_indicator():
    ...
    for index, seat in enumerate(("a", "b", "c")):
        ...
        assert set(data["public"]) == {
            ...
            "stock_count", "top_discard", "winner", "scores", "scoring_rules", "normal_finish", "winning_pair", "won_by_fold", "tunnela_declaration_pending",
        }
        ...
        for p in data["public"]["players"]:
            assert set(p) == {"player_id", "hand_count", "route", "shown_melds", "has_seen_maal", "finished", "folded", "tunnela_declared", "initial_tunnelas"}
