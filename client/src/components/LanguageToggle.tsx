...
export function LanguageToggle() {
  ...
  return <Pressable accessibilityRole="button" accessibilityLabel={t('language.switchTo', { language: label })}
    onPress={() => setLanguage(next)} style={({ pressed }) => ({ ...gameControlFinish(colors, pressed), minWidth: 44, minHeight: 44, paddingHorizontal: 10, borderRadius: 10,
      borderWidth: 1, borderColor: colors.border, alignItems: 'center', justifyContent: 'center', backgroundColor: pressed ? colors.surfaceRaised : colors.tableHeader })}>
