...
export function RoomLedger({ roomId, session, embedded = false }: { roomId: string; session: Session; embedded?: boolean }) {
  ...
  const balances = (rows: Balance[]) => rows.length ? <RoundResultsTable icon="receipt-outline" title={t('ledger.balanceSummary')} playerHeading={t('ledger.player')}
