...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  action: { minHeight: 46, borderRadius: 9, backgroundColor: colors.surfaceSelected, paddingHorizontal: 16, paddingVertical: 13, justifyContent: 'center', alignItems: 'center' },
  actionLabel: { fontFamily: fonts.medium, fontSize: 12, color: colors.text, textAlign: 'center' }, secondary: { backgroundColor: 'transparent', borderWidth: 1, borderColor: colors.border },
