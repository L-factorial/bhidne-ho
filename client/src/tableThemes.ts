...
export const tableThemes = {
  ...
  heritage: { name: 'Nepali Heritage', description: 'Paral, a village house and a chautari', felt: ['#72502F', '#35261C'], trim: '#D4AD69', colors: {
    ...
    textMuted: '#DFCCB4', border: '#B49A7A', borderSubtle: '#634B35', primarySoft: '#493426', tableHeader: '#302117', tableTrim: '#D4AD69', resultOwnSurface: '#493426',
  } as ThemeColors },
  dusk: { name: 'Himalayan Dusk', description: 'Mountain silhouettes beneath an evening sky', felt: ['#38476B', '#1C243E'], trim: '#ADA4CC', colors: {
    ...
    textMuted: '#CBD0E2', border: '#939FBF', borderSubtle: '#424D69', primarySoft: '#303B55', tableHeader: '#1B2238', tableTrim: '#ADA4CC', resultOwnSurface: '#303B55',
  } as ThemeColors },
};
